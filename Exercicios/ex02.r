#Exercícios
#● Carregar os data frames "Orange" e
#"ToothGrowth".
#– Orange (crescimento de laranjeiras)
#– ToothGrowth (efeitos da vitamina C no crescimento de
#dentes em porquinhos-da-índia)
#● Aplicar as funções str() e table() para entender
#as dimensões desses data frames.
